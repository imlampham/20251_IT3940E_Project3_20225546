...
ips =
{
    ...
    rules = [[
    	...
    	include /usr/local/snort3/etc/rules/dynamic_blocks.rules
    ]]
}
...
{
	--ICMP Ping Scan
	{gid = 1, sid = 1000001, track = 'by_src', count = 5, seconds = 10, new_action = 'drop', timeout = 30,},

	--TCP SYN Scan
	{gid = 1, sid = 1000002, track = 'by_src', count = 15, seconds = 10, new_action = 'drop', timeout = 30,},
	
	--TCP Connect Scan
	{gid = 1, sid = 1000003, track = 'by_src', count = 15, seconds = 10, new_action = 'drop', timeout = 30,},
	
	--TCP ACK Scan
	{gid = 1, sid = 1000007, track = 'by_src', count = 15, seconds = 10, new_action = 'drop', timeout = 30,},
}
--]]
...
--alert_csv = { }
alert_fast = {packet = true, buffers = rule, file = true}
--alert_full = { }
--alert_sfsocket = { }
--alert_syslog = { }
--unified2 = { }
